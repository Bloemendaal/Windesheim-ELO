         ...
         functions: {
            ...
            container: function(t, e) {
               ...
               if (e.target.nodeName == 'I') {
                  ...
                  append.data('id', id);
                  setFolder(append, id);
                  $('#nav-folder-list').prepend('<li class="mdc-list-item mdc-list-item--activated" data-mdc-auto-init="MDCRipple" data-id="-1" data-type="0"><i class="material-icons mdc-list-item__graphic" aria-hidden="true">folder_special</i><span class="folder-text-padding">'+$this.data('name')+'</span></li><hr class="mdc-list-divider">');
               }
            },
            fab: function() {
